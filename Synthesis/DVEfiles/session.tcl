...
# DVE full session
# Saved on Tue Oct 7 14:30:28 2014
# Designs open: 0
...
#<Session mode="Full" path="/home1/msc01/ntu-tum/Module3/Synthesis/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{5 24} {723 712}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 368} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 368} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
